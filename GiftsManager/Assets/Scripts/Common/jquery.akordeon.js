(function ($) {
    $.fn.extend({
        ...
        akordeon: function (options) {
            var settings = $.extend({ isExpandedItem: true, expandedItem: 0, expandSpeed: 200, toggle: false, expandText: '&ndash;', collapseText: '+', buttons: true, hiddenItem: -1, itemsOrder: [] }, options);
            return this.each(function () {

                var isExpandedItem = settings.isExpandedItem;
